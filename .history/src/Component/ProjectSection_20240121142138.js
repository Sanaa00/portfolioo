...
function ProjectSection() {
  return (
       <section id="projects" className=" flex flex-col justify-center items-center py-20  lg:mt-10 z-10">
            ...
            <div className='grid sm:grid-cols-2 lg:grid-cols-3  gap-10 mt-5 bg-neutral-200 gap-5'>     {
                 projects.map((project) => {
                      return <div key={project.id} className='relative animate__animated  animate__fadeIn animate__slower'>
                           ...
                           <div className='mt-2 flex items-center justify-between'>
                                ...
                                <div className='flex  2xl:text-xl items-center text-orange'>
                                     <Link to={project.demo} className=''><PiLinkFill /></Link>
