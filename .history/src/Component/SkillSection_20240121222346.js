...
function SkillSection() {
  ...
  return (
       <section id="skills" className='dark:text-neutral-100 text-neutral-600 py-20 sm:my-0 w-full flex flex-col justify-center items-center '>
            ...
            <div className='grid sm:grid-cols-2 sm:gap-10 gap-5 w-full mt-8 animate__animated  animate__fadeIn animate__slower'>
                 {skills.map((skill) => {
                 return <div key={skill.id} className='text-neutral-50 flex w-full justify-start pl-4 items-center h-12 bg-purple5 rounded'>
                      <div >{skill.icon}</div>
