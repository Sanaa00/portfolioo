...
function SkillSection() {
  return (
    ...
    >
      ...
      <div className="grid sm:grid-cols-2 sm:gap-10 gap-5  mt-8 animate__animated  animate__fadeIn animate__slower">
        {skills.map((skill) => {
          return (
            <div
              key={skill.id}
              className="text-txColor flex px-8 py-1 justify-start pl-4 items-center h-12 bg-bgPinkSection rounded-full"
            >
              <div>{skill.icon}</div>
