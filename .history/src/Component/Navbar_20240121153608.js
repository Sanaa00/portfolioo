...
function Navbar() {
  ...
  return (
    ...
    >
        ...
        <div
          className={" dark:bg-dark bg-opacity-70 dark:bg-opacity-70 bg-neutral-50 px-6 sm:px-12 md:px-20 lg:px-26 xl:px-36 z-50   fixed w-full text-xl 2xl:text-2xl flex flex-row justify-between items-center  h-20 font-semibold " }
        >
