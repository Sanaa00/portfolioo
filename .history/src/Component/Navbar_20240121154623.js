...
function Navbar() {
  ...
  return (
    <div
      className={`bg-neutral-50 text-neutral-600 dark:bg-dark dark:text-neutral-50 z-50`}
    ...
    >
      ...
      offset={50} 
              duration={500} 
              activeClass="text-orange dark:text-orange"
              to="home"
                 className={({ isActive }) =>
                (isActive ? "text-orange dark:text-orange " : "") +
                " hover:duration-500  dark:hover:text-gray-300 duration-500  mr-4"
              }
      ...
      duration={500} 
                to="skills"
                 className={({ isActive }) =>
                (isActive ? "text-orange dark:text-orange" : "") +
                " hover:duration-500 hover:text-gray-600 dark:hover:text-gray-300 duration-500 px-2 mx-2"
              }
            >
              Skills
            </Link>
      ...
      smooth={true} 
      offset={50} 
      duration={500}  to="home" className="sm:hidden ml-2 text-2xl font-semibold text-orange">About</Link>
            </div>
