       ...
       <section id="projects" className=" flex flex-col justify-center items-center py-20  lg:mt-10 z-10">
            ...
            <div className='grid sm:grid-cols-2 lg:grid-cols-3  gap-10 mt-5 '>     {
                 projects.map((project) => {
                      return <div key={project.id} className='relative  bg-neutral-100 animate__animated  animate__fadeIn animate__slower'>
                           ...
                           <div className='mt-2 p-4 flex items-center justify-between'>
