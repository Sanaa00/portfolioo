...
function Navbar() {
  ...
  return (
    ...
    >
      ...
      duration={500} 
                to="skills"
                 className={" hover:duration-500 hover:text-gray-600 dark:hover:text-gray-300 duration-500 px-2 mx-2"}
            >
              Skills
            </Link>
            <Link
      ...
      duration={500} 
              to="projects"
              className={" hover:duration-500  dark:hover:text-gray-300 duration-500 px-2 mx-2"}
