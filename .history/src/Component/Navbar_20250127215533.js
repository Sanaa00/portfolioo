...
function Navbar() {
  ...
  return (
    <div
      className={`bg-neutral-50 text-txColor dark:bg-dark dark:text-neutral-100 z-50`}
    >
      <div className="flex flex-col  ">
        <div
          className={
            ' dark:bg-dark bg-opacity-80 dark:bg-opacity-80 bg-neutral-50 px-6 sm:px-12 md:px-20 lg:px-26 xl:px-36 z-50   fixed w-full text-xl 2xl:text-2xl flex flex-row justify-between items-center  h-20 font-semibold '
          }
        >
          <div className="hidden sm:flex  items-center ">
            <Link
              ...
              to="home"
              className={' hover:duration-500 duration-500  mr-4'}
            >
              About
            </Link>
          ...
          <div className="hidden sm:flex items-center ">
            ...
            <a
              href={cv}
              download
              className=" lg:ml-3 flex items-center text-sm 2xl:text-lg hover:bg-opacity-80 duration-500 hover:duration-500 font-semibold bg-purple5 text-neutral-50 rounded px-6 py-1"
            >
              Resume
          ...
          <div className="sm:hidden">
            <div
              className={`sm:hidden flex justify-between hover:bg-opacity-80 duration-500 hover:duration-500 items-center w-full h-full text-lg font-bold font-Poppins text-neutral-50 `}
            >
              <Theme />
                ...
                <div className="w-full items-center h-screen flex flex-col text-purple5">
                  ...
                  <div className="flex sm:hidden items-center ">
                    <a
                      href={cv}
                      download
                      className="mt-5 flex items-center text-sm font-semibold bg-purple5 text-neutral-50 rounded px-6 py-1"
                    >
                      Resume{' '}
                      <AiOutlineDownload className="ml-1 w-6 h-6 text-neutral-50" />
                    </a>
                  </div>
                </div>
              </div>
