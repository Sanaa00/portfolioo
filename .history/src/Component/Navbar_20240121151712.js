  ...
  return (
    ...
    >
      ...
      duration={500} 
            ...
            <a href={cv} download className=" lg:ml-3 flex items-center text-sm 2xl:text-lg hover:bg-opacity-80 duration-500 hover:duration-500 font-semibold bg-purple5 text-grayy rounded px-6 py-1">
              Resume
