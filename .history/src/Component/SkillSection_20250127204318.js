  ...
  return (
    ...
    >
      ...
      <div className="w-full ">
        ...
        <Slider {...settings} className="flex w-full justify-between ">
          {skills.map((skill) => {
            return (
              <div
                key={skill.id}
                className="text-txColor flex flex-row px-8 py-1 justify-center text-ellipsis pl-4 items-center bg-bgPink rounded-full w-full mx-10"
              >
                <div>{skill.icon}</div>
