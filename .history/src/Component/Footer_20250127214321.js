...
function Footer() {
  return (
    <div className="bg-bgPink flex-col sm:flex-row-reverse text-txColor w-full border-t-2 border-bgPinkSection flex justify-between py-5 sm:h-fit  px-4 lg:px-20">
      {/* <Container> */}
