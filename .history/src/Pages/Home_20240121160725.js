...
function Home() {
  ...
  return (
    <section
       id="home"
      className={`bg-grayy dark:bg-dark flex flex-col w-full  justify-center items-center  py-16 `}
    >
      ...
      <div className="py-10 pt-20 sm:mt-10 sm:my-0 flex flex-col justify-center items-center w-full">
        ...
        <p className="animate__animated  animate__fadeIn animate__slower text-xl sm:text-2xl 2xl:text-3xl font-semibold mt-8">About Me</p>
          <p
            className={`animate__animated  animate__fadeIn animate__slower  text-gray-600 dark:text-grayy text-lg 2xl:text-xl w-full text-justify  lg:text-center mt-3 px-6`}
          >
