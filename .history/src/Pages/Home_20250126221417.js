  ...
  return (
    ...
    >
      <div className="w-full flex justify-between items-center ">
        <div className="w-full flex justify-center items-center">   <p>sanarizgar34@gmail.com</p><button>cv</button>
        <div className="w-full flex justify-center items-center"><p>Linkedin</p>  /   <p>Github</p></div>
        </div>
      </div>
