...
function Home() {
  ...
  return (
    <section
       id="home"
      className={` dark:text-neutral-100 text-txColor dark:bg-dark flex flex-col w-full justify-center items-center py-16 relative overflow-hidden min-h-screen sm:h-fit`}
    >
    
      <div className="py-10 pt-20 sm:mt-10 sm:my-0 flex flex-col justify-center items-center w-full">
      <img alt="sana" className="border object-cover w-60 h-60 rounded-full " src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=1000&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8cG9ydHJhaXR8ZW58MHx8MHx8fDA%3D"/>
          <p className="animate__animated  animate__slideInDown flex text-2xl sm:text-3xl 2xl:text-4xl text-gradient font-bold text-orange mt-5">
            Sana Rizgar
          </p>
          <p className="animate__animated  animate__slideInDown text-center text-xl sm:text-3xl 2xl:text-6xl text-orange font-bold mt-1 sm:mt-2">
