...
function Home() {
  return (
    <section
      id="home"
      className={` dark:text-neutral-100 text-txColor dark:bg-dark flex flex-col w-full  items-center  relative overflow-hidden min-h-screen sm:h-fit px-20`}
    >
      <div className="w-full flex justify-between items-center mt-8">
        <div className="w-full flex  items-center">
          {' '}
          <p className=""> sanarizgar34@gmail.com</p>
          <button className="mx-2 bg-bgPinkSection px-8 py-1 rounded-full flex justify-center items-center">
            cv
          </button>
          <div className="w-full flex justify-end items-center">
            <p>Linkedin</p> <p className="mx-2">/</p> <p>Github</p>
          </div>
        </div>
      </div>
      <div className=" pt-20 sm:mt-10 sm:my-0 flex flex-col justify-center items-center w-full">
        <img
          alt="sana"
