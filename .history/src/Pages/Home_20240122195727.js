...
function Home() {
  ...
  return (
    <section
       id="home"
      className={` dark:text-neutral-100 text-neutral-600 dark:bg-dark flex flex-col w-full justify-center items-center py-16 relative overflow-hidden min-h-screen sm:h-fit`}
    >
