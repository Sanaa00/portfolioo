...
function Home() {
  ...
  return (
    <section
       id="home"
      className={` dark:text-neutral-100 text-txColor dark:bg-dark flex flex-col w-full relative overflow-hidden min-h-screen sm:h-fit`}
    >
      <div className=" w-full flex justify-between items-center">
        <div>  <p>sanarizgar34@gmail.com</p><button>cv</button>
        <div><p>Linkedin</p>  /   <p>Github</p></div>
        </div>
      </div>
