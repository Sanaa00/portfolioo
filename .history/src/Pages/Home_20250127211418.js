...
function Home() {
  return (
    <section
      id="home"
      className={` dark:text-neutral-100 text-txColor mt-20 sm:mt-0 dark:bg-dark flex flex-col w-full  items-center  relative overflow-hidden min-h-screen sm:h-fit px-20`}
    >
      ...
      <div className="py-10 pt-20 sm:mt-10 sm:my-0 flex flex-col h-full justify-center items-center w-full">
        <img
          alt="sana"
