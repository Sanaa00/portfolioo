...
function Home() {
  return (
    <section
      id="home"
      className={` dark:text-neutral-100 text-txColor dark:bg-dark flex flex-col w-full  items-center  relative overflow-hidden min-h-screen sm:h-fit  px-4 sm:px-20`}
    >
