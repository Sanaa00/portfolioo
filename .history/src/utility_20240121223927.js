...
import { TbBrandCss3, TbBrandJavascript, TbBrandNextjs, TbBrandRedux, TbBrandTypescript } from "react-icons/tb";
import { FaGithub } from "react-icons/fa";
import { AiFillHtml5, AiOutlineHtml5 } from "react-icons/ai";
import { CgNpm } from "react-icons/cg";
import { SiCss3 ,SiTailwindcss,SiNpm ,SiTypescript, SiRedux} from "react-icons/si";
...
export  const skills = [
          {
               id: 1,
               name: "HTML",
               icon:<AiOutlineHtml5 className='w-8 h-8'/>
          },
           {
               id: 2,
               name: "CSS",
               icon:<TbBrandCss3  className='w-7 h-7'/>

          },
            {
               id: 3,
               name: "JavaScript",
               icon:<TbBrandJavascript  className='w-8 h-8'/>
          ...
          },
             {
          ...
          },
              {
               ...
               id: 6,
               name: "Typescript",
               icon:<TbBrandTypescript className='w-7 h-7'/>
          },
                {
               id: 7,
               name: "NextJs",
               ...
               id: 8,
               name: "Git & Github",
               icon:<VscGithubAlt className='w-7 h-7 font-bold'/>
          },
                              {
               id: 9,
               name: "TailwindCss",
