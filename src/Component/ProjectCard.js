...
function ProjectCard() {
  ...
  return (
    <div className=" xl:pt-10 grid grid-cols-1 grid-rows-2 lg:grid-cols-2 xl:grid-cols-3 w-full gap-10 justify-between items-center font-Poppins">
      {data.map((project) => {
        return (
          <a
            href={project.link}
          ...
          >
            <div className="flex justify-center items-center mt-4">
              <img
                className="h-52 w-60 object-cover rounded-full"
                alt="projects"
                src={project.url}
              />
            </div>
