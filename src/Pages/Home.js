  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center items-center text-gray-800 w-full mt-10">
        <img
          className="rounded-full  w-60 h-60 lg:h-80 lg:w-80 object-cover  hover:scale-105 hover:duration-500 duration-500"
        ...
        <div className=" flex flex-col justify-center items-center mt-5">
          ...
          <p className=" text-center text-md sm:text-xl text-transparent bg-clip-text text-orange font-bold mt-1 sm:mt-2">
