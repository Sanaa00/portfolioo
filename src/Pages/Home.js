...
function Home() {
  ...
  return (
    <div
      ...
      } + h-screen flex flex-col w-full  items-center font-Zen `}
    >
      <div className="flex flex-col justify-center items-center text-gray-800 w-full h-full">
        <img
        ...
        <div className=" flex flex-col justify-center items-center mt-5">
          ...
          <p className=" text-center text-md sm:text-xl text-transparent bg-clip-text bg-gradient-to-r from-pinkk to-purplee font-bold mt-1 sm:mt-2">
